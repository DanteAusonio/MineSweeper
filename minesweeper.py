...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                new_cell = (i, j)
                if 0 <= i < self.height and 0 <= j < self.height:
                    if new_cell in self.mines:
                        count -= 1
                        continue
                    if new_cell == cell or new_cell in self.moves_made:
                        continue
        ...
        for sen1 in self.knowledge:
            for sen2 in self.knowledge:
                if sen2 != sen1 and len(sen1.cells) != 0 and len(sen2.cells) != 0:
                    if sen1.cells.issubset(sen2.cells):
                        new_sentence = Sentence(sen2.cells - sen1.cells, sen2.count - sen1.count)
                        if new_sentence not in self.knowledge:
                            self.knowledge.append(new_sentence)
                    elif sen2.cells.issubset(sen1.cells):
                        new_sentence = Sentence(sen1.cells - sen2.cells, sen1.count - sen2.count)
                        if new_sentence not in self.knowledge:
                            self.knowledge.append(new_sentence)
